...
ALTER TABLE depart ADD CONSTRAINT pk_DEPART PRIMARY KEY (dept_no);
...
ALTER TABLE EMPLE ADD CONSTRAINT fk_DEPART FOREIGN KEY (DEPT_NO) REFERENCES DEPART(DEPT_NO);
